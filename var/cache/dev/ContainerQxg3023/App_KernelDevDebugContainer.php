...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('upload', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('upload', $e, $f, $g));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('upload', $e, $f, $g));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'upload' => [
                    'uri_prefix' => '/images/',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/'),
