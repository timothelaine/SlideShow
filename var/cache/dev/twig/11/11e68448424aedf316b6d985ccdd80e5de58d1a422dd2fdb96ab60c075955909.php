...
class __TwigTemplate_79bef1226a76a451441e21b51188d089c20c16fc48905fe58895b3ce251e36f2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container max-w-full mx-auto \">
        ...
        echo "\" class=\"text-md block px-3 py-2  rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none\">
                                    ...
                                    <div class=\"py-2\" x-data=\"{ show: true }\">
                                        ...
                                        <div class=\"relative\">
                                            <input id=\"password\" name=\"_password\" type=\"password\"  :type=\"show ? 'password' : 'text'\" class=\"text-md block px-3 py-2 rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none\">
                                    ...
                                    <button type=\"submit\" class=\"mt-3 text-lg font-semibold bg-gray-800 w-full text-white rounded-lg px-6 py-3 block shadow-xl hover:text-white hover:bg-black\">Se connecter</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class=\"mt-6\">
                            ...
                            <form class=\"mt-8\" method=\"post\" action=\"{{ path('login') }}\">
                                <div class=\"mx-auto max-w-lg\">
                                    <div class=\"py-2\">
                                        <label class=\"px-1 text-sm text-gray-600\" for=\"username\">Email</label>
                                        <input id=\"email\" name=\"_username\" type=\"email\" type=\"text\" value=\"{{ last_username }}\" class=\"text-md block px-3 py-2  rounded-lg w-full bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md focus:placeholder-gray-500 focus:bg-white focus:border-gray-600 focus:outline-none\">
                                    </div>
                                    <div class=\"py-2\" x-data=\"{ show: true }\">
                                        <label class=\"px-1 text-sm text-gray-600\" for=\"password\">Mot de passe</label>
                                        <div class=\"relative\">
...
{% endblock %}
", "security/login.html.twig", "/home/pierre/Documents/SlideShow/templates/security/login.html.twig");
    }
}
